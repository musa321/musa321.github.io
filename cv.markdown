...
- **Semester Credits:** 23 | **SGPA:** 7.09 | **CGPA:** 7.09
...
- **Semester Credits:** 18 | **SGPA:** 7.72 | **CGPA:** 7.80
...
- **Semester Credits:** 21 | **SGPA:** 8.10 | **CGPA:** 8.08
...
### Master's Level Courses (M.Tech Materials Engineering)
- **Thermodynamics and Kinetics** (MT 202) - Grade: B+
- **Texture and Grain Boundary Engineering** (MT 206) - Grade: B+
- **Mechanical Behaviour of Materials** (MT 253) - Grade: A
- **Computational Mathematics for Materials Engineers** (MT 217) - Grade: D
- **Structure and Properties of Materials** (MT 204) - Grade: A+
- **Diffusion in Solids** (MT 208) - Grade: B+
- **Defects in Materials** (MT 209) - Grade: A
- **Modeling and Simulation in Materials Engineering** (MT 218) - Grade: B+
- **Fracture** (MT 256) - Grade: B
- **Electron Microscopy in Materials Characterization** (MT 306) - Grade: A
- **Materials Informatics** (MT 303) - Grade: B+

### Bachelor's Level Courses (B.Tech Ceramic Engineering)
#### Core Ceramic Engineering Courses
- **Materials Thermodynamics** (CR2101) - Grade: B
- **Unit Operations in Ceramic Processing** (CR2401) - Grade: B
- **Ceramic Raw Materials** (CR2403) - Grade: B
- **Structure and Phase equilibrium in ceramics** (CR2102) - Grade: B
- **Process Ceramics** (CR2104) - Grade: C
- **High temperature processes in ceramics** (CR2106) - Grade: C
- **Fuels and Furnace Technology** (CR2408) - Grade: C
- **Physical Ceramics: Properties** (CR3101) - Grade: A
- **Application of Phase Diagram** (CR3103) - Grade: A
- **Heat Transfer and Fluid Flow** (CR3105) - Grade: C
- **Instrumental Characterization** (CR3201) - Grade: EX
- **Refractory Technology** (CR3401) - Grade: C
- **Interface Science and Sol-gel Processing** (CR3202) - Grade: A
- **Glass Technology** (CR3402) - Grade: EX
- **Whiteware Technology** (CR3404) - Grade: D
- **Metallurgical Processes** (CR3416) - Grade: B
- **Structural Ceramics** (CR4101) - Grade: A
- **Nanoceramics** (CR4201) - Grade: A
- **Bioceramics** (CR4203) - Grade: C
- **Composite Materials** (CR4205) - Grade: A
- **Tribology of Materials** (CR4102) - Grade: A
- **Ceramic Coating** (CR4204) - Grade: B
- **Electroceramics** (CR4302) - Grade: B

#### Minor Degree Courses (Metallurgical and Materials Engineering)
- **Iron Making and Steel Making** (MM2308) - Grade: D
- **Structure and Properties of Materials** (MM2108) - Grade: A
- **Fundamentals of Physical Metallurgy** (MM3109) - Grade: B
- **Materials Characterization Techniques** (MM4512) - Grade: EX
- **Mechanical Metallurgy** (MM3207) - Grade: B

#### Laboratory Courses
- **Chemical Analysis Laboratory** (CR2410) - Grade: A
- **Unit Operations Laboratory** (CR2405) - Grade: A
- **High Temperature Processing Laboratory** (CR2108) - Grade: A
- **Instrumental Characterization Laboratory** (CR3203) - Grade: EX
- **Refractory Laboratory** (CR3403) - Grade: A
- **MATLAB and Simulink Laboratory** (CR3205) - Grade: B
- **Glass Laboratory** (CR3408) - Grade: EX
- **Whiteware Technology Laboratory** (CR3410) - Grade: A
- **Cement Technology Laboratory** (CR3412) - Grade: A
- **Mechanical Testing Laboratory** (CR4103) - Grade: B
- **Equipment Design Laboratory** (CR6174) - Grade: B
- **Finite Element Laboratory** (CR4202) - Grade: B
- **Ceramography and microscopy Laboratory** (CR4105) - Grade: EX
- **Electroceramics Laboratory** (CR4304) - Grade: EX
- **Physical Metallurgy Laboratory** (MM4123) - Grade: A
- **Mechanical Metallurgy Laboratory** (MM4222) - Grade: A

#### Project Work
- **Research Project-I** (CR4091) - Grade: C
- **Research Project-II** (CR4092) - Grade: A
- **Seminar and Technical Writing-I** (CR4903) - Grade: C
- **Seminar and Technical Writing-II** (CR4904) - Grade: A
- **Comprehensive Viva Voce** (CR4908) - Grade: A
